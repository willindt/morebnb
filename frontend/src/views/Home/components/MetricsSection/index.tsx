      ...
      <Flex flexDirection={['column', null, null, 'row']}>
        <IconCard {...TradesCardData} borderColor="#ff0e32" color="primary" title="Farms" mr={[null, null, null, '16px']} mb={['16px', null, null, '0']}>
          <StatCardContent
            ...
            bodyText={t('Earn DDR Token by Staking in LP tokens Maximize your earning via Auto-compoundings')}
        ...
        <IconCard {...StakedCardData} borderColor="#ff0e32" color="failure" title="Pools"  mr={[null, null, null, '16px']} mb={['16px', null, null, '0']}>
          <StatCardContent
            ...
            bodyText={t('Stake Other Tokens to Earn DDR Token with our Pools, High APR per Day, Week, Monthly and Yearly')}
            highlightColor={theme.colors.primary}
          />
        </IconCard>
        <IconCard {...LotteryCardData} borderColor="#ff0e32" color="secondary" title="Jackpot" mr={[null, null, null, '16px']} mb={['16px', null, null, '0']}>
          <StatCardContent
            headingText={t('Chance to Earn $DDR From Stake in Jackpot')}
            bodyText={t('Enjoy our No Loss JackPot. Stake your Token and chance to win a reward of Pool earning')}
